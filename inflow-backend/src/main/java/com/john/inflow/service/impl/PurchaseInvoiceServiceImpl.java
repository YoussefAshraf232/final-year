...
public class PurchaseInvoiceServiceImpl implements PurchaseInvoiceService {
    ...
    public PurchaseInvoiceResponse create(CreatePurchaseInvoiceRequest request, Integer userId) {
        ...
        for (PurchaseInvoiceItemRequest itemRequest : request.items()) {
            ...
            stockMovementService.record(product, warehouse, "PURCHASE", itemRequest.amount(), itemRequest.price(), "PURCHASE_INVOICE", savedInvoice.getId(), null, user);
        ...
        auditLogService.log(user, "CREATE", "PURCHASE_INVOICE", savedInvoice.getId(), "totalPrice=" + totalPrice);
